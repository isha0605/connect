...
@frappe.whitelist()
def get_partner_work_hours(thread=None, dm_thread=None):
	from connect.utils import get_partner_hours_for_thread
	return get_partner_hours_for_thread(thread=thread, dm_thread=dm_thread)
